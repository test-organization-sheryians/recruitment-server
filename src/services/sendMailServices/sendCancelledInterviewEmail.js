  ...
  <div style="font-family: Inter, Arial, sans-serif; background:#ffffff; padding:40px;">
    <div style="max-width:620px; margin:0 auto; color:#111827;">
      ...
      <p style="font-size:15px; line-height:1.7; color:#374151; margin-bottom:24px;">
        ...
        <strong>${data.jobTitle}</strong> position has been cancelled.
      </p>
      ...
      ">
        ...
        <p style="margin:6px 0 0; font-size:16px; font-weight:600; color:#b91c1c;">
          Cancelled
        </p>
      ...
      ">
        <p style="margin:0; font-size:14px; color:#374151;">
          If this cancellation was unintentional or if rescheduling is required,
