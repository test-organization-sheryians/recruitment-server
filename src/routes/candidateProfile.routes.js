...
router.put("/:userId", authenticateJWT, candidateProfileController.updateProfile);
router.patch("/:userId", authenticateJWT, candidateProfileController.updateProfile);

router.delete("/:userId", authenticateJWT, candidateProfileController.deleteProfile);

router.post("/:userId/skills", authenticateJWT, candidateProfileController.addSkills);
...
router.post("/:userId/resume", authenticateJWT, candidateProfileController.uploadResume);
